...
function createRealDeps(context) {
  ...
  return {
    ...
    async setupPythonVenv() {
      ...
      await runCommand(venvPython, ["-m", "pip", "install", "-r", requirementsPath], commandOptions());
