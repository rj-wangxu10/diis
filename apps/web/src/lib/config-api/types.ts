...
// ── Semantic Graph types (datasource-scoped) ──────────────────────────

export type SemanticGraphBuildResultDto = {
  build_id: string;
...
export type SemanticGraphBuildHistoryDto = {
  build_id: string;
  user_id: string;
  datasource_id: string;
  mode: string;
...
export type SemanticGraphRelationDto = {
  id?: string;
  relation_id?: string;
  from_table: string;
  to_table: string;
...
export type SemanticGraphExportDto = {
  datasourceId: string;
  tables: unknown[];
  columns: unknown[];
  relations: unknown[];
